...
class SmallPopupViewController: NSViewController {
    ...
    let message = ["주의하십시오. 당신의 눈은\n지금 휴식이 필요합니다",
                   "휴식을 취할 시간이에요!\n지금 시작해볼까요?",
                   "LiquidEye가 당신의 눈휴식을 도울거에요. 참여하시겠습니까?",
                   "지금 휴식 취하지 않으면, 당신은\n심각한 눈관련 질병에 노출될 수 있습니다. ",
                   "컴퓨터 시력증후군을 예방하기 위해서\n지금 휴식에 참여하는 것이 어떠세요?", "눈 휴식을 취하고 눈손상을\n예방해 볼까요?", "당신의 눈이 위험합니다", "당신의 눈을 지키는 것이 열심히\n일하는 것보다 중요하지 않을까요?", "경고: 휴식을 취하십시오", "지나친 컴퓨터 사용은 당신의\n눈을 죽이고 있습니다", "당신의 눈을 버리지 마십시오", "건강한 눈을 원하신다면\n참여해보시는게 어때요?", "작은 휴식이 당신의 눈을\n보호해 줄 수 있어요~"]
    ...
    override func viewWillAppear() {
        ...
        if preset.notiColor == 0 {
            ...
            button1.layer?.shadowColor = NSColor.lightGray.cgColor
            button2.layer?.shadowColor = NSColor.lightGray.cgColor
            button3.layer?.shadowColor = NSColor.lightGray.cgColor
        } else {
